...
public class CreateServiceInstanceVolumeBindingTest extends SimpleScenarioTest<CreateServiceInstanceVolumeBindingStage> {
    ...
    private static CatalogSettings catalog_with_same_volume_mount_for_all_service_plans() {
    ...
    private static CatalogSettings catalog_with_volume_mount_set_for_a_service_plan() {
        Plan dev = new Plan("dev");
        dev.setId("dev-id");
        dev.setCredentials(uriCredentials());
