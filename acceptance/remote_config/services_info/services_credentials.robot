...
Credential info in service key of each service plan should match configuration
	...
	TRIPADVISOR_test_Service3		default		&{TRIPADVISOR_credentials}		
	API_DIRECTORY_test_Service3		dev 		&{API_DIRECTORY_dev_credentials}
    API_DIRECTORY_test_Service3 	preprod     &{API_DIRECTORY_preprod_credentials}
    API_DIRECTORY_test_Service3 	prod        &{API_DIRECTORY_prod_credentials}
	static-creds-service-test3 		myplan 		&{ID_credentials}
