...
Resource        remote_config_resource.robot
...
2) Credential info should match initial configuration 
	...
	Credential info in service key of service API_DIRECTORY_test_Service3 plan prod should match configuration &{API_DIRECTORY_prod_credentials}
...
4) Credential info should match updated configuration 
	...
	Credential info in service key of service API_DIRECTORY_test_Service3 plan prod should match configuration &{updated_API_DIRECTORY_prod_credentials}
